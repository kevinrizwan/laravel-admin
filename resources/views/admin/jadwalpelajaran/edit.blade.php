        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    <li><a href="#">Update Kendaraan172</a></li>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body card-block">
                ...
                <form action="{{route('jadwalpelajaran.update', $data->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    @method('PATCH')
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" id="text-input" name="no_plat" value="{{$data->no_plat}}" placeholder="Masukkan no plat..." class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" id="text-input" name="merk_kendaraan" value="{{$data->merk_kendaraan}}" placeholder="Masukkan merek kendaraan..." class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" id="text-input" name="nama_pemilik" value="{{$data->nama_pemilik}}" placeholder="Masukkan nama pemilik..." class="form-control" required>
                        </div>
                    </div>
            </div>
