            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a href="{{route('jadwalpelajaran.create')}}" class="btn btn-primary pull-right"> Tambah </a>
                    </div>
                    <div class="card-body">
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>No Plat172</th>
                                    <th>Merek Kendaraan172</th>
                                    <th>Nama Pemilik172</th>
                                    <th>Edit</th>
                                    <th>Hapus</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route('jadwalpelajaran.edit', $row->id)}}" class='btn btn-primary'>Edit </a> </td>
                                    <td>
                                        <form action="{{route('jadwalpelajaran.destroy', $row->id)}}" method="post">
                                            @csrf
                                            @method('DELETE')
